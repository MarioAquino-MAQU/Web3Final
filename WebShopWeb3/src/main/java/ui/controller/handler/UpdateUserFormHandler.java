...
public class UpdateUserFormHandler extends RequestHandler {

	private ShopService service;
	
	public UpdateUserFormHandler() {
	...
	public void HandleRequest(HttpSession session, Cookie cookie, HttpServletRequest request,
		...
		if(session.getAttribute("role") != null && session.getAttribute("role").equals("Admin")){
			String destination = "updatePerson.jsp";
			Role[] enumlijst = Role.values();
			request.setAttribute("enumlijst", enumlijst);
